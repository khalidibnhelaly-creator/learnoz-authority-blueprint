  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Learnoz Custom Colors
        engineering: {
          blue: "hsl(var(--engineering-blue))",
          "blue-deep": "hsl(var(--engineering-blue-deep))",
          "blue-light": "hsl(var(--engineering-blue-light))",
        },
        safety: {
          yellow: "hsl(var(--safety-yellow))",
          "yellow-dark": "hsl(var(--safety-yellow-dark))",
        },
        industrial: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 20px -5px hsla(51, 100%, 50%, 0.4)" },
          "50%": { boxShadow: "0 0 40px -5px hsla(51, 100%, 50%, 0.7)" },
        },
      },
      animation: {
